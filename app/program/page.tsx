      ...
      <div className="program-container">
        ...
        <section className="accessories-section">
          ...
          <div className="acc-card">
            <div className="acc-icon"><img src="https://picsum.photos/id/1058/150/150" alt="Sangles TRX" /></div>
          ...
          <div className="acc-card">
            <div className="acc-icon"><img src="https://picsum.photos/id/338/150/150" alt="Parallettes" /></div>
            <div className="acc-details">
